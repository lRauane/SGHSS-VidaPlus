...
Revision ID: 682ad7b8efe1
Revises: 
Create Date: 2025-05-10 11:25:01.542621
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('paciente_id', sa.Integer(), nullable=False),
    sa.Column('lista_consultas', sa.Integer(), nullable=True),
    sa.Column('lista_prescricoes', sa.Integer(), nullable=True),
    sa.Column('lista_exames', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['lista_consultas'], ['consultas.id'], ),
    sa.ForeignKeyConstraint(['lista_exames'], ['exames.id'], ),
    sa.ForeignKeyConstraint(['lista_prescricoes'], ['prescricoes.id'], ),
    sa.ForeignKeyConstraint(['paciente_id'], ['paciente_users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
